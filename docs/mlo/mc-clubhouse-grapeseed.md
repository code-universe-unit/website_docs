...
<table>
  <tr>
    ...
    <td>
      ...
      <strong>Texture NAME:</strong> gc_bikers_ext_art
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      ...
      <strong>Texture NAME:</strong> gc_bclub_wall_posters
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      ...
      <strong>Texture NAME:</strong> gc_garage_art_04; gc_garage_art_04_dop
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <strong>YTD NAME:</strong> gc_bclub_int<br>
      <strong>Texture NAME:</strong> gc_bclub_wall_logos
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <strong>YTD NAME:</strong> gc_bclub_int<br>
      <strong>Texture NAME:</strong> gc_furn_trash_d
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <strong>YTD NAME:</strong> gc_bclub_int<br>
      <strong>Texture NAME:</strong> gc_garage_art_02
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <strong>YTD NAME:</strong> gc_bclub_int<br>
      <strong>Texture NAME:</strong>  gc_garage_art_01
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <strong>YTD NAME:</strong> gc_bclub_int<br>
      <strong>Texture NAME:</strong> gc_garage_posters_01; gc_garage_posters_02
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <strong>YTD NAME:</strong> gc_bclub_int<br>
      <strong>Texture NAME:</strong> gc_bclub_wall_graffiti_01
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <strong>YTD NAME:</strong> gc_bclub_art<br>
      <strong>Texture NAME:</strong> gc_bclub_table_planning
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <strong>YTD NAME:</strong> gc_bclub_int<br>
      <strong>Texture NAME:</strong> gc_garage_posters_03
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <strong>YTD NAME:</strong> gc_bclub_int<br>
      <strong>Texture NAME:</strong> wallpaper_txt_check
    </td>
  </tr>
...
```
gc_bclub_door_metal
gc_bclub_door_metal_2
gc_bclub_door_metal_2_l
gc_bclub_door_metal_2_r
gc_bclub_door_metal_garage
gc_bclub_door_metal_l
gc_bclub_door_metal_r
gc_bclub_basement_door
```
...
hi@cs2_01_7.ybn
hi@cs2_01_9.ybn
vw_distlodlights_medium003.ymap
vw_distlodlights_small002.ymap
vw_lodlights_medium003.ymap
vw_lodlights_small002.ymap
hei_cs2_01.ymap
hei_cs2_01_critical_0.ymap
hei_cs2_01_long_0.ymap
hei_cs2_01_strm_0.ymap
hei_cs2_01_strm_1.ymap
hei_cs2_01_strm_2.ymap
hei_cs2_01_strm_3.ymap
cs2_01_decal_carpark.ydr
cs2_01_land02.ydr
cs2_occl_02.ymap
cs2_roadsb_wire_spline104.ydr
cs2_roadsb_wire_spline121.ydr
```
